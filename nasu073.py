...
Original file is located at
    https://colab.research.google.com/drive/1DVgVMCNUAzYQFEijHqEYAjl-3A8EBxbF?hl=ja#scrollTo=RHd5d3Gwg_G5
"""
    ...
    def minimax(self, board, piece, depth, maximizing_player):
        ...
        if maximizing_player:
            ...
            for move in valid_moves:
                ...
                new_board[r, c] = piece
                eval, _ = self.minimax(new_board, -piece, depth - 1, False)
                if eval > max_eval:
                    max_eval = eval
                    best_move = move
            ...
            for move in valid_moves:
                ...
                stones_to_flip = flip_stones(new_board, r, c, piece)
                new_board[r, c] = piece
                eval, _ = self.minimax(new_board, -piece, depth - 1, True)
                if eval < min_eval:
                    min_eval = eval
                    best_move = move
